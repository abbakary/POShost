    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(default='UTC', help_text='User timezone for displaying dates and times', max_length=100)),
        ...
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['sku'], name='idx_item_sku'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['barcode'], name='idx_item_barcode'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['item', 'created_at'], name='tracker_inv_item_id_71cf40_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryadjustment',
            index=models.Index(fields=['adjustment_type'], name='tracker_inv_adjustm_b7d6e2_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryadjustment',
            index=models.Index(fields=['reference'], name='tracker_inv_referen_c65f17_idx'),
        ),
        migrations.AddIndex(
            model_name='vehicle',
